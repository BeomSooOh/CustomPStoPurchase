...
<!-- javascript -->
<script>
	/* UserYesil2BudgetAcctPop var */
	
	/* document.ready */
	$(document).ready(function() {
		log('+ [UserYesil2BudgetAcctPop] (document).ready');
		var defaultInfo = { 
		...
		fnUserYesil2BudgetAcctPopInit(defaultInfo);
		fnUserYesil2BudgetAcctPopEventInit();
	...
	/* 초기화 */
	function fnUserYesil2BudgetAcctPopInit(defaultInfo) {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopInit');
		fnUserYesil2BudgetAcctPopLayout();
		fnUserYesil2BudgetAcctPopDatepicker();
		fnUserYesil2BudgetAcctPopInitInput();
		fnUserYesil2BudgetAcctPopInitButton(defaultInfo);
		log('- [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopInit');
		return;
	}0
	
	/* 초기화 - Layout */
	function fnUserYesil2BudgetAcctPopLayout() {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopLayout');
	...
	/* 초기화 - Datepicker */
	function fnUserYesil2BudgetAcctPopDatepicker() {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopDatepicker');
		fnInitDatePicker();
		log('- [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopDatepicker');
		return;
	}
	...
	/* 초기화 - Event */
	function fnUserYesil2BudgetAcctPopEventInit() {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopEventInit');
	...
	/* 초기화 - Input */
	function fnUserYesil2BudgetAcctPopInitInput() {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopInitInput');
		
		log('- [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopInitInput');
		return;
	}
	/* 초기화 - Button */
	function fnUserYesil2BudgetAcctPopInitButton(defaultInfo) {
		log('+ [UserYesil2BudgetAcctPop] fnUserYesil2BudgetAcctPopInitButton');
	...
	function fnGetMaingridData(defaultInfo){
	    ...
	    $.ajax({
	        type : 'post',
	        url : '<c:url value="/ex/expend/user/ExUserYesil2BudgetAcctInfo.do" />',
	        datatype : 'json',
	        async : true,
	        data : param,
