...
<script>
	...
	function fnUserExpendReportSearch() {
		var result = ajax({
			url : "/expend/ex/user/ExUserExpendReportListInfoSelect.do",
			async : false,
			parameter : {
				fromDate : ($('#txtFromDate').val().toString()
						.replace(/-/g, '') || ''), /* 결의(회계)일자 */
				...
				docTitle : ($('#txtDocTitle').val().toString()
						.replace(/-/g, '') || '')
			}
		});
		...
		var columnDefs = [
				...
				},
				{
					...
					"data" : null,
					"render" : function(data) {
						return '<a href="javascript:;" onClick="javascript: fnAppdocPop('
								+ "'"
								+ data.docSeq
								+ "', '"
								+ data.formSeq
				...
				},
				{
					...
					"data" : null,
					"render" : function(data) {
						return '<a href="javascript:;" onClick="javascript: fnPrintPop('
								+ "'" + data.expendSeq + "'" + ')">[인쇄]</a>';
					}
				}, {
					"targets" : 8,
		...
		setTableCust($('#tblExpendUserReport'), columnDefs, columns,
				result.aaData, '20');
	}
	...
	<div class="sub_contents_wrap">
		...
		<div class="top_box">
			<dl>
				...
				<!-- <dt>기안자</dt> -->
				<!-- <dd><input type="text" style="width: 120px;" /></dd> -->
				<!-- <dt>문서상태</dt> -->
				<!-- <dd><input id="doc_sta_sel" style="width: 100px;" class="kendoComboBox" /></dd> -->
				<dd>
