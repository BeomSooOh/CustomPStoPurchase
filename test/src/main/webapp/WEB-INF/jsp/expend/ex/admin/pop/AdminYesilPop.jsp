	...
	function fnSetMainList(defaultInfo, data){
		...
		if( budgetFlag == "0"){
			aoColumn = [ {
	                ...
	                "sTitle" : "<%=BizboxAMessage.getMessage("TX000000098","부서")%>",
	                "mDataProp" : "DEPT_NM",
	                "bVisible" : true,
	                "bSortable" : true,
	                "sWidth" : "",
			...
			aoColumn = [ {
                ...
                "sTitle" : "<%=BizboxAMessage.getMessage("TX000019020","부문")%>",
                "mDataProp" : "SECT_NM",
                "bVisible" : true,
                "bSortable" : true,
                "sWidth" : "",
