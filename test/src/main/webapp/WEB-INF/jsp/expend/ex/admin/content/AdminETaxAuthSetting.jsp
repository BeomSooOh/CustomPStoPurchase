...
<div class="sub_contents_wrap">
    ...
    <div class="btn_div cl">
        <div class="left_div mt5">
            <p class="tit_p m0">${CL.ex_elecTaxBillSet} <!--전자세금계산서 설정--> (<span id="spanETaxResultCount">10</span>) <span class="fwn f11 ml20">${CL.ex_elecDocComment2} <!--전자세금계산서의 공개범위 권한을 설정합니다.--></span></p>
        </div>
        <div class="right_div">
