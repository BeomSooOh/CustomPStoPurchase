...
<!-- javascript -->
<script>
	/* AdminYesil2BizPlanPop var */
	
	/* document.ready */
	$(document).ready(function() {
		
		log('+ [AdminYesil2BizPlanPop] (document).ready');
		$('#text_input').focus();
		
		fnAdminYesil2BizPlanPopInit();
		fnAdminYesil2BizPlanPopEventInit();
	...
	/* 초기화 */
	function fnAdminYesil2BizPlanPopInit() {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopInit');
		fnAdminYesil2BizPlanPopLayout();
		fnAdminYesil2BizPlanPopDatepicker();
		fnAdminYesil2BizPlanPopInitInput();
		fnAdminYesil2BizPlanPopInitButton();
		log('- [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopInit');
		return;
	}0
	
	/* 초기화 - Layout */
	function fnAdminYesil2BizPlanPopLayout() {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopLayout');
	...
	/* 초기화 - Datepicker */
	function fnAdminYesil2BizPlanPopDatepicker() {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopDatepicker');
		fnInitDatePicker();
		log('- [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopDatepicker');
		return;
	}
	...
	/* 초기화 - Event */
	function fnAdminYesil2BizPlanPopEventInit() {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopEventInit');
	...
	/* 초기화 - Input */
	function fnAdminYesil2BizPlanPopInitInput() {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopInitInput');
		
		log('- [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopInitInput');
		return;
	}
	/* 초기화 - Button */
	function fnAdminYesil2BizPlanPopInitButton(defaultInfo) {
		log('+ [AdminYesil2BizPlanPop] fnAdminYesil2BizPlanPopInitButton');
	...
	function fnGetMaingridData(){
	    ...
	    $.ajax({
	        type : 'post',
	        url : '<c:url value="/ex/expend/admin/ExAdminYesil2BizPlanInfo.do" />',
	        datatype : 'json',
	        async : true,
	        data : param,
