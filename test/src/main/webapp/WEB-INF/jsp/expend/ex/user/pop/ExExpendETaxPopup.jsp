        ...
        eTable = $('#tblExpendETaxList').dataTable({
            ...
            "columnDefs" : [ {
                ...
                "render" : function( data ) {
                    if (data != null && data != "") {
                        return '<input type="checkbox" name="inp_ETaxchk" id="inp_ETaxchk' + data.issNo + '|'  + data.issDt + '|' + data.trregNb + '|' +  data.hometaxIssNo + '" value="' + data.issNo + '|' + data.issDt + '|' + data.trregNb + '|' +  data.hometaxIssNo + '|' + (data.syncId || '0') + '" class="k-checkbox" /><label class="k-checkbox-label bdChk" for="inp_ETaxchk' + data.issNo + '|'  + data.issDt + '|' + data.trregNb + '|'  +  data.hometaxIssNo + '"></label>';
                    } else {
                        return "";
                    }
                }
                ...
                "render" : function( data ) {
                    ...
                    result += '<a href="javascript:;" onclick="fnEtaxDetailPopup("' + data.issNo + '");">' + issNoStr + '</a>';
                    return result;
                }
            }, {
                "targets" : 2,
