		...
		$("#divGridArea").GridTable({
			...
			"aoDataRender" : [ { // [*] 실제 데이터 표기 방법에 대하여 지정합니다.
				...
				render : function(idx, item) {
					...
					return '<input type="checkbox" class="chk_row" name="chkETax" onclick="Common.Util.CheckboxStat();" ' + isDisabled + '/>';
				}
			}, {
				no : '1',
				render : function(idx, item) {
	...
	<div class="sub_contents_wrap">
		...
		<div class="top_box">
			<dl>
				...
				<dd>
					<div class="dal_div">
						<input type="text" autocomplete="off" id="txtFromDate" value="" class="w113 enter puddSetup" pudd-type="datepicker"  /> <a href="#n" id="btnFromDate" class="button_dal"></a>
					...
					~
					<div class="dal_div">
						<input type="text" autocomplete="off" id="txtToDate" value="" class="w113 enter puddSetup" pudd-type="datepicker" /> <a href="#n" id="btnToDate" class="button_dal"></a>
						<script type="text/javascript">
							var d = new Date();
...
<!-- 
		<div class="gt_paging mt30">
			<div class="paging mt30">
				<span class="pre"><a
					href="javascript:fnMovePage(currentPage-1)">이전</a></span>
				<ol id="paging"></ol>
				<span class="nex"><a
					href="javascript:fnMovePage(currentPage+1)">다음</a></span>
			</div>

			<div id="" class="gt_count">
				<select class="selectmenu up" style="width: 75px;"
					id="selViewLength">
