...
<script>
		...
		var consHeadMake = function(param){
			...
			$.ajax({
				...
				success : function(result) {
					...
					// fnConsBudgetMake(consSeq, this.mgtSeq);
	...
	function fnConsItemSpecMake(consSeq, ConsReUseParam, gConsDoc, consHeadMakeParam){
		var oldBudgetSeq = '';
		...
		var consBudgetMake = function(consBudgetMakeParam){
			...
			$.ajax({
				...
				success : function(result) {
					...
					fnConsItemSpecMake(consSeq, ConsReUseParam, gConsDoc, consHeadMakeParam);
				},
				error : function(result) {
					console.error(result);
				}
