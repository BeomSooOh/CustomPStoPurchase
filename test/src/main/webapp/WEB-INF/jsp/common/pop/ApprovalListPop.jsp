...
<table class="statement" width="100%">
	...
	<tbody id="tblSlipInfo">
		<tr height="25" class="Tline">
			<th rowspan="2"><b>구분</b></th>
			<th rowspan="2"><b>계정과목</b></th>
			<th><b>프로젝트</b></th>
			<th><b>거래처</b></th>
			<th rowspan="2"><b>차변금액</b></th>
			<th rowspan="2"><b>대변금액</b></th>
			<th rowspan="2"><b>적요</b></th>
		</tr>
		<tr height="25">
			<th><b>법인카드</b></th>
			<th><b>사용자</b></th>
...
<script>
	...
	function fnSetTableData(data){
		...
		for(var i=0; i < length ; i++ ){
			...
			bodyTag += '	<td rowspan="2">' + item.drcrGbn ;
			bodyTag += '		<a onClick="javascript:window.open(\'/exp/ApprovalSlipPop.do?expend_seq=${expendSeq}&list_seq=${listSeq}&group_seq=${groupSeq}&slip_seq='+item.slipSeq+'\',\'\',\'width=700, height=600\')" href="#n" style="color:#3aa1f3;">[상세]</a>';
			bodyTag += '	</td>';
		...
		footerTag += '	<th colspan="4"><b>합계</b></th>';
