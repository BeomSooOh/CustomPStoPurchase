...
$(function(){
    ...
    $(".btnSearch").click(function(){
    	if("${link_yn}" =="N"){
    		alert(<%=BizboxAMessage.getMessage("TX000016531","ERP 연동되어 있지 않습니다")%> + "<%=BizboxAMessage.getMessage("TX000008410","관리자에게 문의 바랍니다")%>");
    	    return;       
    	}
        $("#searchYN").val("Y" );
        $("#EXCEL_YN").val("N" );
...
//                 }
    	    ...
    	    error: function (request,status,error) {
    	    	var temp1 = "<%=BizboxAMessage.getMessage("TX000009711","오류 메시지 : {0}")%>";
    	    	temp1 = temp1.split('{0}')[0];
...
<!--                                 <dd><input id="CO_CD"  name="CO_CD" style="width:160px;" class="formData" /></dd> -->
                        ...
                        <div>
                            <div id="" class="controll_btn">
                                <button type="button" id="btnExcel">Excel <%=BizboxAMessage.getMessage("TX000001687","다운로드")%></button>
                            </div>
                        </div>
