...
<div class="pop_wrap_dir" style="width:828px;" id="ItemsFormPop" >
    <div class="pop_head">
        <h1>물품명세 등록</h1>
        <a href="#n" class="clo"><img src="<c:url value='/Images/btn/btn_pop_clo02.png' />" alt="" onclick="btnOk();" /></a>
    </div>
    <div class="pop_con">   
        ...
        <div class="top_box mt15" style="overflow:hidden;">
            <dl class="dl2">
                <dt>합계 : </dt>
                <dd class="mt20">수량 <span class="colB" id="TOTAL_COUNT">0</span></dd>
                <dd class="text_gray mt20">|</dd>
                <dd class="mt20">금액 <span class="colB" id="TOTAL_AM" >0</span></dd>
            </dl>
        </div>
...
<%--                 <td><a href="javascript:;" id="btndeleteRow"><img src="<c:url value='/images/erp/ico_del.gif'/>" width="14" height="16" alt="" title="삭제" /></a></td> --%>
                ...
                <td>    
                    <div class="controll_btn ac" style=" padding:0px;">
                        <button class="btnSaveRow">저장</button>
                        <button class="btnDeleteRow">삭제</button>
