...
public interface BEzSendInfo {

	 /* 이지바로 ERP 집행요청 데이터 삽입하기 */
	 Map<String,Object> EzHReqInsert(Map<String,Object> map) throws Exception;
	 
	 /* 이지바로 ERP 품목상세 데이터 삽입하기 */
	 Map<String,Object> EzHReqDetailInsert(Map<String,Object> map) throws Exception;
