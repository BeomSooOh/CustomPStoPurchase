...
public interface BBiUserCarService {

	/* ## 코드 조회 ## */
	/* ## 코드 조회 ## - 차량 */
	ResultVO BiUserCarListInfoSelect ( ResultVO result ) throws Exception;

	/* ## 코드 조회 ## - 운행내역 */
	ResultVO BiUserCarHisListInfoSelect ( ResultVO result ) throws Exception;
	/* ## 코드 조회 ## - 마지막 주행 거리 */
	/* ## 코드 조회 ## - 북마트 정보 */
	/* ## 코드 조회 ## - 즐겨찾기 정보 */
	/* ## 코드 조회 ## - 휴일 정보 */
