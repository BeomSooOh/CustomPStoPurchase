...
public interface BExUserEtaxService {
	...
	ResultVO ExExpendETaxInfoUpdate ( ExCodeETaxVO etaxVo, ConnectionVO conVo ) throws Exception;

	/* 매입전자세금계산서 - 세금계산서 현황 리스트 조회 */
	ResultVO ExUserTtaxReportList ( ResultVO param, ConnectionVO conVo ) throws Exception;
	...
	ExCommonResultVO ExExpendETaxInfoMapReset ( Map<String, Object> param ) throws Exception;
}
