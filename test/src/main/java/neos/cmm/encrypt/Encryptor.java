...
public interface Encryptor {
    ...
    //public final String characterEncoding = "UTF-8"; /*인코딩 방식*/
    //public final String cipherTransformation = "AES/CBC/PKCS5Padding"; /*암호화방식/운용방식/패딩*/
    //public final String aesEncryptionAlgorithm = "AES"; /*알고리즘이름*/
