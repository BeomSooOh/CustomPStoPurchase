...
public class MenuCreateManageDAO extends EgovComAbstractDAO{
	...
	public int selectUsrByPk(Map<String, Object> paramMap) throws Exception{
		return (Integer)selectByPk("menuManageDAO.selectUsrByPk", paramMap);  
	}
	...
	public  Map<String, Object>  selectMenuCreatManagList(Map<String, Object> paramMap, PaginationInfo paginationInfo) throws Exception{
		return super.listOfPaging2(paramMap, paginationInfo, "menuManageDAO.selectMenuCreatManageList_D");
	}
