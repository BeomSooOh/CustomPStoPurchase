...
public interface EgovMenuCreateManageService {
	 ...
	 * @exception Exception
	 */
	int selectUsrByPk(Map<String, Object> paramMap) throws Exception;
	 ...
	 * @exception Exception
	 */
	Map<String, Object> selectMenuCreatManagList(Map<String, Object> paramMap, PaginationInfo paginationInfo) throws Exception;
