...
public class EgovComCrossSiteHndlr extends BodyTagSupport {
	/*
	 * (One almost wishes XML and JSP could support "anonymous tags," given the amount of trouble we had naming this one!) :-) - sb
	 */
	...
	/**
	 * 2011.10.10 cmd 라인상에서 편의제공을 위해 제공, 필요없을시 삭제하여도 무방함 public static void main(String[] args) throws IOException {
	 *
	 * EgovComCrossSiteHndlr egovComCrossSiteHndlr = new EgovComCrossSiteHndlr();
	 *
	 * egovComCrossSiteHndlr.value = "TRNSMIT";
	 *
	 * String sCrossSiteHndlr = egovComCrossSiteHndlr.getWriteEscapedXml(); //System.out.println("writeEscapedXml " + egovComCrossSiteHndlr.getWriteEscapedXml()); /* System.out.println("sCrossSiteHndlr|"+ sCrossSiteHndlr + "|");
	 *
	 * try{ System.out.println("TRY TEST 1"); throw new Exception(); }catch(Exception e){ System.out.println("TRY TEST 2"); }finally{ System.out.println("TRY TEST 3");
	 *
	 * } }
	 */
}
