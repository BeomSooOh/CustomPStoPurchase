...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
    ...
    public String index(ModelMap model) {
        ...
        String mode = BizboxAProperties.getProperty("BizboxA.mode");
        if (mode.equals("live")) {
            return "redirect:bizbox.do";
        }
    ...
    public String setLeftMenu(ModelMap model) {
        ...
        if (map == null) {
            ...
            /*
             * EgovLoginController가 AOP Proxy되는 바람에 클래스를 reflection으로 가져올 수 없음 방법을 찾을때까지 임시로 아래 코드 유지
             */
            // try {
