...
public final class CommonMapper {
    ...
    //
    private static String EXUUserERPiUBudgetReport = "/expend/ex/user/content/UserExERPiUYesil";
    ...
    /**
     * 메뉴 : 나의 예실대비 현황 2.0(ERPiU)<br>
     * 호출 : /ex/user/yesil/ExUserERPiUYesilReport.do <br>
     * 반환 : UserExERPiUYesil.jsp
     *
     * <pre>
     * # 로그인 사용자의 권한에 따른 예실대비 내역을 확인할 수 있는 메뉴
     * </pre>
     ...
     * <pre>
     * # 메뉴 변경 이력 및 개선 이력 기록
     *   - (예시) 2019. 12. 03. 이준성 : EPR iU 예실대비현황 2.0 개발
     * </pre>
     */
    public static String GetEXUUserERPiUBudgetReport() {
      return EXUUserERPiUBudgetReport;
    }
 ...
 // 예실대비현황 2.0(ERPiU) 팝업
     ...
     * 반환 :
     */
    private static String EXAdminItemConfig = "/expend/ex/admin/content/AdminExItemSetting";
    ...
    // 지출결의 확장입력 설정
    private static String EXAdminExtInputConfig = "/expend/ex/admin/content/AdminExExtInputItemConfig";

    /* Getter --------------------------------------------------------------------------------------------- */

    /**
     * 메뉴 : 항목설정(BizboxA)<br>
     * 기능 : 지출결의 작성시 표시되는 테이블의 헤더를 정의하는 기능<br>
     * 호출 : /ex/admin/config/ExItemSetting.do <br>
     * 반환 : AdminExItemSetting.jsp
     *
     * <pre>
     * # 메뉴 변경 이력 및 개선 이력 기록
     *   - (예시) 2019. 08. 21. 김상겸 : 기안자 검색조건 추가
     * </pre>
     */
    public static String GetEXAdminItemConfig() {
        return EXAdminItemConfig;
    }

    /**
     * 메뉴 : 확장입력 설정(BizboxA)<br>
     * 기능 : 지출결의 작성시 추가적으로 입력하고자하는 항목을 설정하는 기능<br>
     * 호출 : /ex/admin/config/ExExtInputItemConfig.do <br>
     * 반환 : AdminExExtInputItemConfig.jsp
     *
     * <pre>
     * # 메뉴 변경 이력 및 개선 이력 기록
     *   - 2019. 08. 21. 신규 개발 시작 (김상겸)
     * </pre>
     */
    public static String GetEXAdminExtInputConfig() {
        return EXAdminExtInputConfig;
    }
