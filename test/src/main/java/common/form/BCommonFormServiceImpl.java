...
public class BCommonFormServiceImpl implements BCommonFormService {
    ...
    /**
     * 양식 상세정보 호출 sample { needSample? sample codes.. } formInfo { 양식 명칭등 데이터.. } formCode [code1 : {코드 정보}, code2 : {코드 정보} ... ] form { 본문 html code. }
     */
    @Override
    ...
    /**
     * 비영리 양식 상세정보 호출 sample { needSample? sample codes.. } formInfo { 양식 명칭등 데이터.. } formCode [code1 : {코드 정보}, code2 : {코드 정보} ... ] form { 본문 html code. }
     */
    @Override
    ...
    public ResultVO NPDocMaker(Map<String, Object> params) throws Exception {
        ...
        /**
         * 품의/결의서 본문 데이터 정보 constents [ / 메인 컨텐츠 컨테이너 project [ / 프로젝트(품의/결의) 리스트 budget [ / 예산 정보 리스트 (기본 복수 예산 지원) trade [ / 거래처 리스트 ] ] ] ]
         */
        ...
        if (html.contains("_ADV_INTER_GROUPSEQ_")) {
            try {
                ...
                /*
                 * 3. 파라미터 객체화 파라미터 정보 outProcessInterfaceId / t_exnp_doc.out_process_interface_id outProcessInterfaceMId / t_exnp_doc.out_process_interface_m_id outProcessInterfaceDId / t_exnp_doc.out_process_interface_d_id consDocSeq / t_exnp_doc.cons_doc_seq resDocSeq / t_exnp_doc.res_doc_seq docSts / 0 (고정 값)
                 */
                outProcessParam = interfaceVo.getaData();
                if (!CommonConvert.CommonGetStr(outProcessParam.get("outProcessInterfaceId")).equals(commonCode.EMPTYSTR)) {
                    /* 4. 외부 시스템 양식 호출 */
                    ...
                    if (!CommonConvert.CommonGetStr(CommonConvert.CommonGetStr(outInterfaceVo.getInterfaceCallForm())).equals("")) {
                        ...
                        interfaceResult = JSONObject.fromObject(HttpJsonUtil.execute(commonCode.POST, CommonConvert.CommonGetStr(outInterfaceVo.getInterfaceCallForm()), interfaceParam));
                ...
                throw new Exception("[ERROR] throw Exception When Calling adv inter system. MESSAGE : " + ex.getMessage());
            }
        }
        ...
        if ((params.get("testYN") != null) && (params.get("testYN").toString().equals("Y"))) {
            ...
            /* 헤더 정보 검증 */
            if ((CommonConvert.CommonGetStr(headResultVO.getResultCode()).equals(commonCode.SUCCESS)) && (headResultVO.getAaData().size() == 1)) {
                ...
                if (headData.get("ctlFgCode") != null && CommonConvert.CommonGetStr(headData.get("ctlFgCode")).equals("0")) {
                 ...
                 */
                // [ 참조품의 결의서 ] 품의잔액 - 상신금액
                if (headData.get("confferDocSeq") != null && !CommonConvert.CommonGetStr(headData.get("confferDocSeq")).equals("")) {
            ...
            if (CommonConvert.CommonGetStr(contentsResultVO.getResultCode()).equals(commonCode.SUCCESS)) {
                ...
                for (int i = 0; i < hList.size(); i++) {
                    ...
                    if (item.get("confferBudgetSeq") != null && !CommonConvert.CommonGetStr(item.get("confferBudgetSeq")).equals("")) {
                     ...
                     */
                    // [ 부가세 미포함 옵션 결의 ] 공급대가 = 공급가액 처리
                    if (item.get("ctlFgCode") != null && CommonConvert.CommonGetStr(item.get("ctlFgCode")).equals("0")) {
                ...
                for (int i = 0; i < bList.size(); i++) {
                    ...
                    item.put("stackResultAmt", applyTryAmt);
        ...
        if(confOpt.get("confOpt").equals("1")) {
        	...
        	for(Map<String,Object> projectItem : projectList) {
        		...
        		List<Map<String,Object>> budgetFilteredList = getBudgetListForResSeq(budgetList,CommonConvert.NullToString(projectItem.get("resSeq")));
        		for(Map<String,Object> budgetItem : budgetFilteredList ) {
        			budgetItem.put("tradeList", getTradeListForBudgetSeq(tradeList,CommonConvert.NullToString(budgetItem.get("budgetSeq"))) );
        		}
...
//        }
    ...
    public ResultVO DocMaker(Map<String, Object> params) throws Exception {
        ...
        /* HTML 변환 */
        InterlockHtmlVO htmlVo = new InterlockHtmlVO(listHtml, params.get("expendSeq").toString(), loginVo.getGroupSeq(), testMode);
        ResultVO htmlResult = htmlVo.SetHtmlForm(headData, contentsData, footerData);
        if (!CommonConvert.CommonGetStr(htmlResult.getResultCode()).equals(commonCode.SUCCESS)) {
            return htmlResult;
        }
    ...
    public ResultVO NpDocMake(Map<String, Object> params) throws Exception {
        ...
        //boolean isEa = (CommonConvert.CommonGetStr(params.get("eaType")).equals("ea") ? true : false);
        boolean isEa ;
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(basicInfo.get(0).get("docNo")) + "</span></p>";
        resDocHtml += " 			</td>";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(basicInfo.get(0).get("erpExpendYear")) + "</span></p>";
        resDocHtml += " 			</td>";
        resDocHtml += " 			<td colspan=\"4\" style=\"width:80;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:double #000000 1.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\" bgcolor=\"#e5e5e5\">";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(basicInfo.get(0).get("null")) + "</span></p>";
        resDocHtml += " 			</td>";
        resDocHtml += " 		</tr>";
        resDocHtml += " 		<tr>";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(basicInfo.get(0).get("deptName")) + "</span></p>";
        resDocHtml += " 			</td>";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(budgetInfo.get(0).get("erpBizplanName")) + "</span></p>";
        resDocHtml += " 			</td>";
        resDocHtml += " 			<td colspan=\"4\" style=\"width:80;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\" bgcolor=\"#e5e5e5\">	";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(headInfo.get(0).get("consDate")) + "</span></p>";
        resDocHtml += " 			</td>";
        resDocHtml += " 		</tr>";
        resDocHtml += " 		<tr>";
        resDocHtml += " 			<td colspan=\"2\" style=\"width:80;height:28;border-left:solid #000000 1.1pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\" bgcolor=\"#e5e5e5\">	";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"> <span>일금  원정 (" + CommonConvert.ReturnIntComma(CommonConvert.CommonGetSeq(basicInfo.get(0).get("docAmt"))) + ")</span></p>";
        resDocHtml += " 			</td>";
        ...
        resDocHtml += " 				<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(headInfo.get(0).get("consNote")) + "</span></p>";
        resDocHtml += " 			</td>";
        resDocHtml += " 		</tr>";
        /* 2번 테이블 */
        resDocHtml += " 		<tr>";
        ...
        for (Map<String, Object> tBudget : budgetInfo) {
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + budgetSeq + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tBudget.get("erpBizplanName")) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 		<td colspan=\"2\" style=\"width:69;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle16\" style=\"line-height:160%;background-color:#ffffff;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tBudget.get("erpBgacctName")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle16\" style=\"line-height:160%;background-color:#ffffff;\"><span style=\"font-size:9.7pt;font-family:&quot;HY중고딕&quot;;letter-spacing:-11%;line-height:160%\">" + CommonConvert.CommonGetStr(tBudget.get("erpFiacctName")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetSeq(tBudget.get("null")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.ReturnIntComma(CommonConvert.CommonGetSeq(tBudget.get("budgetAmt"))) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 		<td colspan=\"3\" style=\"width:65;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetSeq(tBudget.get("null")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;;letter-spacing:-13%\">" + CommonConvert.CommonGetStr(tBudget.get("setFgName")) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 	</tr>";
        }
        /* 3번 테이블 */
        ...
        for (Map<String, Object> tTrade : tradeInfo) {
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + trSeq + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tTrade.get("trName")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tTrade.get("depositor")) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tTrade.get("btrName")) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 		<td colspan=\"4\" style=\"width:77;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tTrade.get("baNb")) + "</span></p>";
            resDocHtml += " 		</td>";
            int totalAmt = 0;
            String totalAmtStr = "";
            totalAmt = Integer.parseInt(CommonConvert.CommonGetSeq(tTrade.get("tradeStdAmt"))) + Integer.parseInt(CommonConvert.CommonGetSeq(tTrade.get("tradeVatAmt")));
            totalAmtStr = Integer.toString(totalAmt);
            resDocHtml += " 		<td colspan=\"3\" style=\"width:77;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.ReturnIntComma(totalAmtStr) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 		<td colspan=\"4\" style=\"width:77;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.ReturnIntComma(CommonConvert.CommonGetSeq(tTrade.get("tradeStdAmt"))) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 		<td colspan=\"3\" style=\"width:77;height:28;border-left:solid #000000 0.4pt;border-right:solid #000000 0.4pt;border-top:solid #000000 0.4pt;border-bottom:solid #000000 0.4pt;padding:1.4pt 0.0pt 1.4pt 0.0pt\" valign=\"middle\">";
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:right;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.ReturnIntComma(CommonConvert.CommonGetSeq(tTrade.get("tradeVatAmt"))) + "</span></p>";
            resDocHtml += " 		</td>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.ReturnDateFormat(tTrade.get("regDate")) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 	</tr>";
            resDocHtml += " 	<tr>";
            ...
            resDocHtml += " 			<p class=\"HStyle0\" style=\"text-align:center;\"><span style=\"font-family:&quot;HY중고딕&quot;\">" + CommonConvert.CommonGetStr(tTrade.get("tradeNote")) + "</span></p>";
            resDocHtml += " 		</td>";
            resDocHtml += " 	</tr>";
        }
        resDocHtml += " 	</tbody>";
        ...
        if (formType.equals("CONS") || formType.equals("TRIPCONS")) {
            ...
            if(!jedis.getBuildType().equals("build")) {
            	...
            	for(int i=0; i<jedisConnectionList.size() ;i++) {
            		cmLog.CommonSetInfoToDatabase("cloudDBNEOSfor문진입" + jedisConnectionList.get(i).toString(), "", "EXNP");
            ...
            query += " , IFNULL(SUBSTRING(tattend.trip_from_date,12,5), '') 	AS TA_TRIP_FROM_TIME																";
            query += " , IFNULL(SUBSTRING(tattend.trip_to_date,1,10), '') 		AS TA_TRIP_TO_DATE																	";
            query += " , IFNULL(SUBSTRING(tattend.trip_to_date,12,5), '') 		AS TA_TRIP_TO_TIME																	";query += " , IFNULL( tattend.calendar_name, '' )							AS TA_CALENDAR_NAME																	";
        	query += " , IFNULL( tattend.location_name, '' )							AS TA_LOCATION_NAME																	";
        	query += " , IFNULL( tattend.location_adv, '' )								AS TA_LOCATION_ADV																	";
        	query += " , IFNULL( tattend.transport_name, '' )							AS TA_TRANSPORT_NAME																";
        	query += " , IFNULL( tattend.purpose, '' )									AS TA_PURPOSE																		";
