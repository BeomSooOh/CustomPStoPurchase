...
/**
 * ExErpSendiCUBEVOTest JUnit테스트
 * Created by Kwon Oh Gwang on 2019-05-17.
 */
public class ExErpSendiCUBEVOTest extends TestCase {
	private static final Logger logger = LoggerFactory.getLogger(ExErpSendiCUBEVOTest.class);

	/**
	 * 적요 생성 메서드 테스트
	 */
	@Test
	public void testISU_DOC() {
		String type0 = "NONAME";
		...
		logger.info("### type0 = {}", ISU_DOC(type0));
		logger.info("### type1 = {}", ISU_DOC(type1));
		logger.info("### type2 = {}", ISU_DOC(type2));
		logger.info("### type3 = {}", ISU_DOC(type3));
		logger.info("### type4 = {}", ISU_DOC(type4));
	}
	
	private String ISU_DOC(String noteOptionValue) {
