...
public class CommonBatchCmsDataVO {
    ...
    private void replaceCardData() {
    	this.CHAIN_NM = this.CHAIN_NM.replace("'", "`").replace("\\", "\\\\");
    	this.CHAIN_ADDR1 = this.CHAIN_ADDR1.replace("'", "`").replace("\\", "\\\\");
    	this.CHAIN_ADDR2 = this.CHAIN_ADDR2.replace("'", "`").replace("\\", "\\\\");
    	this.CHAIN_CEO_NM = this.CHAIN_CEO_NM.replace("'", "`").replace("\\", "\\\\");
    	this.BUSINESS_NM = this.BUSINESS_NM.replace("'", "`").replace("\\", "\\\\");
    	this.APPR_TM = this.APPR_TM.replace(":", "").replace("\\", "\\\\");
    }
}
