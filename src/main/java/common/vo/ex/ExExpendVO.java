...
public class ExExpendVO {

    private String groupSeq = commonCode.EMPTYSTR; /* 귀속그룹 시퀀스 */
    ...
    public boolean getComeHistory() {
        return isComeHistory;
    }


    public void setComeHistory(boolean isComeHistory) {
    ...
    public String toString() {
        return "ExExpendVO [groupSeq=" + groupSeq + ", compSeq=" + compSeq + ", erpCompSeq=" + erpCompSeq + ", expendSeq=" + expendSeq + ", docSeq=" + docSeq + ", expendStatCode=" + expendStatCode + ", expendDate=" + expendDate + ", expendReqDate=" + expendReqDate + ", erpSendYN=" + erpSendYN + ", writeSeq=" + writeSeq + ", empSeq=" + empSeq + ", budgetSeq=" + budgetSeq + ", projectSeq=" + projectSeq + ", partnerSeq=" + partnerSeq + ", cardSeq=" + cardSeq + ", jsonStr=" + jsonStr + ", erpSendSeq=" + erpSendSeq + ", rowId=" + rowId + ", inDt=" + inDt + ", inSq=" + inSq + ", formSeq=" + formSeq + ", createSeq=" + createSeq + ", modifySeq=" + modifySeq + ", isComeHistory=" + isComeHistory + ", erpiuBudgetVer=" + erpiuBudgetVer + "]";
    }
}
