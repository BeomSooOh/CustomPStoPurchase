...
public final class ExpInfo {
    ...
    public static void ProcessLog(String message, Object params) {
        ...
        try {
            ...
            sb.append(System.getProperty("line.separator"));
            sb.append(">>>>> [DEF_ProcessLog] groupSeq : ");
            sb.append(login.getGroupSeq());
            sb.append(System.getProperty("line.separator"));
            sb.append(">>>>> [DEF_ProcessLog] compSeq : ");
            sb.append(login.getCompSeq());
            sb.append(System.getProperty("line.separator"));
            sb.append(">>>>> [DEF_ProcessLog] empSeq : ");
            sb.append(login.getUniqId());
        } catch (Exception e) {
        ...
        if (message != null) {
            sb.append(System.getProperty("line.separator"));
            sb.append(">>>>> [DEF_ProcessLog] message : ");
            sb.append(message);
        } else {
            sb.append(System.getProperty("line.separator"));
        ...
        if (params != null) {
            sb.append(System.getProperty("line.separator"));
            sb.append(">>>>> [DEF_ProcessLog] params : ");
            sb.append(params);
        } else {
            sb.append(System.getProperty("line.separator"));
