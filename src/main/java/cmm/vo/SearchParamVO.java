...
public class SearchParamVO {
	...
	public String getSearchText() {
		if(c_dititle != null && !c_dititle.trim().equals("")){
			return c_dititle;
		}else if(username != null && !username.trim().equals("")){
			return username;
		}
		else if(c_ridocnum != null && !c_ridocnum.trim().equals("")){
			return c_ridocnum;
		}
		else if(orgdept != null && !orgdept.trim().equals("")){
			return orgdept;
		}
		else{
			return "";
	...
	private String getDate(Date date, String formatString)
	{
		...
		SimpleDateFormat formatInput = new SimpleDateFormat(formatString, Locale.getDefault());
