...
public class AESEncryptor implements Encryptor {
	...
	public static final String KEY = "dk2fjl9skjj5flwoiwerlkzxkdadlesr";/*암호화 키*/
	public static final String CHARACTERENCODING = "UTF-8"; /*인코딩 방식*/
	public static final String CIPHERTRANSFORMATION = "AES/CBC/PKCS5Padding"; /*암호화방식/운용방식/패딩*/
	public static final String AESENCRYPTIONALGORITHM = "AES"; /*알고리즘이름*/
	...
	private byte[] decrypt ( byte[] cipherText, byte[] key, byte[] initialVector ) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
		Cipher cipher = Cipher.getInstance( CHARACTERENCODING );
