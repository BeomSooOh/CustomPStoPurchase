...
@Service ( "FEx2AdminCodeServiceA" )
public class FEx2AdminCodeServiceAImpl implements FEx2AdminCodeService {

	/* 변수정의 */
	/* 변수정의 - DAO */
	@Resource ( name = "FEx2AdminCodeServiceADAO" )
	private FEx2AdminCodeServiceADAO dao;
	...
	public List<Map<String, Object>> Ex2AdminCommCodeSelect(Map<String, Object> params, ConnectionVO conVo) throws Exception {
		...
		if ( codeType.toUpperCase( ).equals( commonCode.SUMMARY ) ) {
			//return dao.Ex2CommonCodeSummarySelect( params, conVo );
			return dao.Ex2CommonCodeSummarySelect( params );
		}
		else {
