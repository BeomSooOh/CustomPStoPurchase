...
@Service ( "FExUserServiceU" )
public class FExUserServiceUImpl implements FExUserService {
	/* 변수정의 */
	/* 변수정의 - DAO */
	/* 변수정의 - Class */
	...
	/* 전자결재 작성한 회사시퀀스 조회 */
	@Override
	public String ExDocCompSeqInfoSelect ( Map<String, Object> param ){ return null; }
}