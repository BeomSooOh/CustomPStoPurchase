...
@Service ( "FExMasterConfigServiceI" )
public class FExMasterConfigServiceIImpl implements FExMasterConfigService {
	...
	public ResultVO ExCodeCardInfoFromErpCopy ( Map<String, Object> parms, ConnectionVO conVo ) throws Exception {
		cmLog.CommonSetInfo( "+ [EX] FExMasterConfigServiceIImpl - ExCodeCardInfoFromErpCopy" );
		cmLog.CommonSetInfo( "! [EX] Map<String, Object> parms parms >> " + parms );
		ResultVO result = new ResultVO( );
		exMasterConfigServiceIDAO.getCardErpData( parms );
	...
	public List<Map<String, Object>> ExCodeVatTypeListInfoSelect ( Map<String, Object> parms, ConnectionVO conVo ) throws Exception {
		...
		try {
			vatTeypListVo = exMasterConfigServiceIDAO.ExCodeVatTypeListInfoSelect( parms, conVo );
		}
		catch ( Exception e ) {
