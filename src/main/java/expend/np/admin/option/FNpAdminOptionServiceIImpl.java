...
@Service ( "FNpAdminOptionServiceI" )
public class FNpAdminOptionServiceIImpl implements FNpAdminOptionService {

	/* 변수정의 */
	/* 변수정의 - DAO */
	@Resource ( name = "FNpAdminOptionServiceIDAO" )
	private FNpAdminOptionServiceIDAO dao;
