...
@Service("FNpAdminETaxServiceU")
public class FNpAdminETaxServiceUImpl implements FNpAdminETaxService {

	/* 변수정의 */
	/* 변수정의 - DAO */
	@Resource(name = "FNpAdminETaxServiceUDAO")
	private FNpAdminETaxServiceUDAO dao;
