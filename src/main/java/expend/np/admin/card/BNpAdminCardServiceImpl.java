...
@Service("BNpAdminCardService")
public class BNpAdminCardServiceImpl implements BNpAdminCardService {

	/* SERVICE IMPL */
	@Resource(name = "FNpAdminCardService")
	private FNpAdminCardService service;
	...
	@Override
	public ResultVO GetCardBatchTime(Map<String, Object> params) throws Exception {
		ResultVO result = new ResultVO();
		/* 카드사용내역 최종 배치 시각 조회 */
		result = service.GetCardBatchTime(params);
		return result;
	}
}
