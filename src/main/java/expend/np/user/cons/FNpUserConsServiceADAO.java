...
public class FNpUserConsServiceADAO extends EgovComAbstractDAO {
	...
	public ResultVO selectConsInCustom(Map<String, Object> params) throws Exception { // TODO: 백상휘 수정.
		...
		try {
			resultMap.put("consDocInfo", list( "NpUserConsA.selectConsDocAuthenticated", params ));
			resultMap.put("consHeadInfo", list( "NpUserConsA.selectConsHeadAuthenticated", params ));
			resultMap.put("budgetInfo", list( "NpUserConsA.selectConsBudgetAuthenticated", params ));
			resultMap.put("tradeInfo", list( "NpUserConsA.selectConsTradeAuthenticated", params ));
