/**
  * @FileName : FAcUserProcessServicePImpl.java
  * @Project : BizboxA_exp
  * @변경이력 :
  * @프로그램 설명 :
  */
 ...
 *   
 */
@Service ( "FAcUserProcessServiceP" )
public class FAcUserProcessServicePImpl implements FAcUserProcessService {

	/* 변수정의 */
	/* 변수정의 - DAO */
	@Resource ( name = "FAcUserProcessServicePDAO" )
	private FAcUserProcessServicePDAO dao;
