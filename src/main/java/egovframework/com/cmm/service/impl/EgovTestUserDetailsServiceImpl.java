...
public class EgovTestUserDetailsServiceImpl extends AbstractServiceImpl implements EgovUserDetailsService {
	...
	public Object getAuthenticatedUser ( ) {
		...
		loginVO.setUniqId( "A00010000000001" );
		return loginVO;
		// return
	...
	public Boolean isAuthenticated ( ) {
		// 인증된 유저인지 확인한다.
		/*
		 * if (RequestContextHolder.getRequestAttributes() == null) { return false; } else {
		 * if (RequestContextHolder.getRequestAttributes().getAttribute( "loginVO", RequestAttributes.SCOPE_SESSION) == null) { return false; } else { return true; } }
		 */
		return true;
	}
