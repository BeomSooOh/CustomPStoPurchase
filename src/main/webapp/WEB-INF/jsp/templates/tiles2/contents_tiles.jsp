...
<div class="iframe_wrap" style="min-width:1200px">
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/pudd.css' />">
	...
	<script type="text/javascript" src='${pageContext.request.contextPath}/js/pudding/framework.js'></script>
