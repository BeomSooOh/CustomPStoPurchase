			...
			<table>
				<thead>
					<tr>
						...
						<th width="14%">${CL.ex_resBgtSum}  <!--결의금액 합계--></th>
						<th width="14%">${CL.ex_notTransResSum}  <!--미전송 결의 합계--></th>
						<th width="14%">${CL.ex_transResSum}  <!--전송 결의 합계--></th>
					</tr>
				</thead>
...
<script>
	...
	function fnSetTotalTable(item) {
		...
		tr += '	<td class="ri"> ' + fnShowAmt( item.sendResAmt + item.nonSendResAmt ) + ' </td>';
