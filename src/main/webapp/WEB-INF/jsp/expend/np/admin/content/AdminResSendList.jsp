...
<form id="excelDownload" name="excel" method="post">
    ...
    <input type="hidden" name="erpSendYN" value="" id="formErpSend" />
    <input type="hidden" name="erpSendDt" value="" id="formErpSendDt" />
