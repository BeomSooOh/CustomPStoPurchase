...
<div class="sub_contents_wrap">
	...
	<div class="top_box">
		<dl style="height: 40px;">
			...
			<dd>
				<input type="text" autocomplete="off" style="width:199px;" class="puddSetup" id="txtErpDeptName" readonly/>
				<input type="hidden" style="width:227px;" class="puddSetup" id="txtErpDeptSeq"/>
				<input type="button" id="btnErpDeptSelect" class="puddSetup" pudd-style="height:22px;margin-left:3px;vertical-align: top;" value="${CL.ex_select}" /><!--선택-->
			</dd>
