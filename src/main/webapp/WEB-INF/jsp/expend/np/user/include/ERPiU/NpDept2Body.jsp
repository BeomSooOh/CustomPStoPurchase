		...
		<dl>					
			...
			<dd>
				<select class="puddSetup" pudd-style="width:80px" id="selSearchType">
					...
					<option value="NM_BUDGET">${CL.ex_deptNm}  <!--부서명--></option>
				</select>
			</dd>
			<dd>
...
// 		$("#title").text("예산단위");
	...
	function fnSetPageParam( param ){
		param.stdDate = "20180401";//$("#txtStdYM").val().toString().replace(/-/g, '');
		param.deptName = "";
