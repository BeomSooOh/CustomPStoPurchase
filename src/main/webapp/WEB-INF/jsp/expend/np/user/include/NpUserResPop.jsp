...
var Option = {
		Common : {
			...
			SetTooltip : function(target, column) {
				...
				var msgDef = {
						docuFgName : '${CL.ex_resDefMsg1}',
						resDate : '${CL.ex_resDefMsg2}',
						resNote : '${CL.ex_resDefMsg3}',
						btrNb : '${CL.ex_resDefMsg4}',
						causeEmpName : '${CL.ex_resDefMsg5}',
						statement : '${CL.ex_resDefMsg6}',
						erpBudgetName : '${CL.ex_resDefMsg7}',
						erpBizplanName : '${CL.ex_resDefMsg8}',
						erpBgacctName : '${CL.ex_resDefMsg9}',
						erpFiacctName : '${CL.ex_resDefMsg10}',
						setFgName : '${CL.ex_resDefMsg11}',
						vatFgName : '${CL.ex_resDefMsg12}',
						trFgName : '${CL.ex_resDefMsg13}',
						budgetNote : '${CL.ex_resDefMsg14}',
						trName : '${CL.ex_resDefMsg15}',
						businessNb : '${CL.ex_resDefMsg16}',
						ceoName : '${CL.ex_resDefMsg17}',
						tradeAmt : '${CL.ex_resDefMsg18}',
						tradeStdAmt : '${CL.ex_resDefMsg19}',
						tradeVatAmt : '${CL.ex_resDefMsg20}',
						btrName : '${CL.ex_resDefMsg21}',
						baNb : '${CL.ex_resDefMsg22}',
						depositor : '${CL.ex_resDefMsg23}',
						tradeNote : '${CL.ex_resDefMsg24}',
						regDate : '${CL.ex_resDefMsg25}',
						erpMgtName : '${CL.ex_resDefMsg26}',
						erpDivName : '${CL.ex_resDefMsg27}',
						ctrName : '${CL.ex_resDefMsg28}',
						bottomName : '${CL.ex_resDefMsg29}',
				};
			...
			GetSaveParam : function(param) {
				...
				/* 날짜 포맷 변경 대상 */
				var dateFormatTarget = [ 'resDate', 'regDate', 'erpGisuDate', 'expendDate', 'causeDate', 'signDate', 'inspectDate','payplanDate' ];
				/* 날짜 포맷 변경 대상 - 포맷 변경 */
			...
			GetCalcAmt : function(baseAmt, amtType, mathType) {
				...
				case 'amt2std':
					return math[mathType](baseAmt / 11 * 10); /* amt2std : 총금액 기준 부가세 있는 공급가액 구하기 */
				case 'amt2vat':
		...
		ERPiU : {
			...
			GetDocuFg : function() {
				...
				if(!optionSet.gw){
					...
					return docuFgArray;
				} else if( !optionSet.gw[3][9] ){
					return docuFgArray;
				} else {
					var returnArr = [];
					for( var i=0; i < docuFgArray.length; i++ ){
						var item = docuFgArray[i];
						if(optionSet.gw[3][9].setValue.indexOf(item.docuFgCode) > -1){
							returnArr.push(item);
						}
					}
					return returnArr;
			...
			GetVatFg : function() {
				...
				if(optionSet){
					if(optionSet.erp) {
						if(optionSet.erp.NON_DEDUCTIBLE) {
							if (optionSet.erp.NON_DEDUCTIBLE.CD_ENV == 'Y'){
								vatFgArray.push({
									'vatFgCode' : '4',
			...
			GetTrFg : function(setFgCode, vatFgCode) {
				...
				if (setFgCode === '' && vatFgCode === '') {
					...
					if (vatFgCode === '1' || vatFgCode === '2') {
						/* 과세 || 면세 */
						trFgArray.push(trFgSource[0]);
					} else if (setFgCode === '4' && vatFgCode === '3'){
						trFgArray.push(trFgSource[0]);
						trFgArray.push(trFgSource[2]);
					} else if (vatFgCode === '3') {
						/* 기타 */
			...
			GetBudgetAmtInfo : function(key) {
				...
				if (((budgetData.resSeq || '') !== '') && budgetChkKey.indexOf(key) > -1) {
					...
					if ((budgetData.erpBudgetName || '') === '' 
							|| (budgetData.erpBizplanName || '') == ( (!!(optionSet.erp['TP_BUDGETMNG'].CD_ENV == '0'))  ? '1' : '' ) 
			...
			GetTradeNoteReqYN : function (){
				if( !optionSet.gw ){
					return NO;
				} else if( !optionSet.gw['CUST'] ){
					return NO;
				} else if( !optionSet.gw['CUST']['CUST1'] ){
					return NO;
				} else if( optionSet.gw['CUST']['CUST1'].setValue == 0 ){
					return YES;
				} else {
					return NO;
				}
			...
			GetTradeColumns : function() {
				...
				var display = [];
				var req = [];
				var checkRegDateOpt = (optionSet.gw[3][15]||{'setValue':'1'}).setValue
					...
					"1" : {
						...
						"1" : {
							...
							"1" : function() {
								...
								req = [ YES, YES, NO, YES, YES, YES, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), checkRegDateOpt==0?YES:NO  ];
							}
						},
						"2" : {
							/* 면세 */
							"1" : function() {
								...
								req = [ YES, YES, NO, YES, YES, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), checkRegDateOpt==0?YES:NO ];
							}
						},
						"3" : {
							/* 기타 */
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), checkRegDateOpt==0?YES:NO ];
							},
							"2" : function() {
								/* 사원등록 */
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), checkRegDateOpt==0?YES:NO ];
							},
							"3" : function() {
								/* 거래처명 */
						...
						"4" : {
							...
							"1" : function() {
								...
								req = [ YES, NO, YES, YES, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), checkRegDateOpt==0?YES:NO ];
							}
						}
					},
					"2" : {
						...
						"1" : {
							...
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, YES, YES, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
						},
						"2" : {
							/* 면세 */
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, YES, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
						},
						"3" : {
							/* 기타 */
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"2" : function() {
								/* 사원등록 */
								title = [ '${CL.ex_employeeNm}'
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"3" : function() {
								/* 거래처명 */
								title = [ '${CL.ex_vendorNm}'
							...
							"4" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"5" : function() {
								/* 급여 */
								/* 급여의 경우 사용자 급여 노출 문제로 인하여 개발하지 않음 */
						...
						"4" : {
							...
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
						}
					},
					"3" : {
					...
					"4" : {
						...
						"1" : {
							...
							"1" : function() {
								...
								, '${CL.ex_note3}'
								, '${CL.ex_reportDate}' ];
								column = [ 'trName', 'businessNb', 'ceoName', 'tradeAmt', 'tradeStdAmt', 'tradeVatAmt', 'btrName', 'baNb', 'depositor', 'ctrName', 'tradeNote', 'regDate' ];
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
						},
						"2" : {
							/* 면세 */
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
						},
						"3" : {
							/* 기타 */
							"1" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, YES, NO, YES, NO, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"2" : function() {
								/* 사원등록 */
								title = [ '${CL.ex_employeeNm}'
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, NO, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"3" : function() {
								/* 거래처명 */
								title = [ '${CL.ex_vendorNm}'
							...
							"4" : function() {
								...
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, NO, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							},
							"5" : function() {
								/* 급여 */
								/* 급여의 경우 사용자 급여 노출 문제로 인하여 개발하지 않음 */
						...
						"4" : {
							...
							"1" : function() {
								...
								, '${CL.ex_note3}'
								, '${CL.ex_reportDate}' ];
								column = [ 'trName', 'ceoName', 'noTaxName', 'tradeAmt', 'tradeStdAmt', 'tradeVatAmt', 'btrName', 'baNb', 'depositor', 'ctrName', 'tradeNote', 'regDate' ];
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, YES, YES, NO, NO, NO, NO, Option.ERPiU.GetTradeNoteReqYN(), NO ];
							}
				...
				$.each(title, function(idx, item) {
					...
					case 'trName':
						...
						columnDef.methods = {
							...
							keyEventDefault: function () {
								if(!!$('#tradeTbl').dzt('getValue').trSeq){
									return this.keyEventDelete();
								}
		                    },
					...
					case 'btrName':
						...
						columnDef.methods = {
                            ...
                            keyEventDefault: function () {
                                if(!!$('#tradeTbl').dzt('getValue').btrSeq){
                                    return this.keyEventDelete();
                                }
                            },
							keyEventDelete : function() {
					...
					case 'baNb':
						...
						columnDef.methods = {
							keyEventF2 : function(keyName, searchStr) {
								...
								var budgetData = $('#budgetTbl').dzt('getValue');
								var tradeData = $('#tradeTbl').dzt('getValue');
								fnCommonCode('baNb', keyName, searchStr, resData, tradeData);
								return false;
							},
							keyEventEnter : function() {
								var tradeData = $('#tradeTbl').dzt('getValue');
					...
					case 'regDate':
						...
						columnDef.lastCallback = function() {
                            ...
                            /*비고(채주) 특수문자 체크*/
                            if(special_pattern.test(tradeData.tradeNote)){
							...
							if (($('#budgetTbl').find('.colOn').length + $('#tradeTbl').find('.colOn').length) === 0) {
								...
								if (($('#tradeTbl').dzt('getValue').tradeSeq || '0') !== '0') {
									$('#btnTradeAdd').click();
								} else {
		...
		iCUBE : {
			...
			GetTrFg : function(setFgCode, vatFgCode) {
				...
				if(vatFgCode === '3' && setFgCode === '4'){
					...
					{
						'trFgCode' : '6',
						'trFgName' : '${CL.ex_operatingexpenses}',
						tradeChange : 'N'
					}];
				} else if (vatFgCode === '3') {
					trFgArray = [ {
					...
					{ 'trFgCode': '8', 'trFgName': '${CL.ex_salary}', tradeChange: 'N' },
					{
						'trFgCode' : '9',
						'trFgName' : '${CL.ex_businessIncomeEarner}',
						tradeChange : 'N'
			...
			GetBudgetAmtInfo : function(key) {
				...
				if(!!resData.bottomSeq){
					budgetData.bottomSeq = resData.bottomSeq;
					budgetData.bottomName = resData.bottomName;
				}
					...
					"1" : {
						...
						"3" : {
							...
							"4" : function() {
								...
								type = [ 'text', 'text', 'readonly', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES ];
					...
					"4" : {
						...
						"2" : {
							...
							"1" : function() {
								...
								, '${CL.ex_note3}'
								, '${CL.ex_reportDate}' ];
								column = [ 'trName', 'ceoName', 'tradeAmt', 'tradeStdAmt', 'btrName', 'baNb', 'depositor', 'ctrName', 'tradeNote', 'regDate' ];
								type = [ 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'datepicker' ];
								display = [ YES, YES, YES, YES, YES, YES, YES, YES, YES, YES ];
								req = [ YES, NO, YES, YES, NO, NO, NO, NO, NO, NO ];
							}
				...
				$.each(title, function(idx, item) {
						...
						columnDef.methods = {
							...
							keyEventDelete : function() {
								...
								$('#tradeTbl').dzt('setValue', uid, {
									trSeq : '',
									btrSeq : '',
									businessNb : ('card|etax'.indexOf(tradeData.interfaceType) != -1)?tradeData.businessNb:'',
									ceoName : '',
									btrName : '',
									baNb : '',
									depositor : ''
                    ...
                    case 'tradeNote':
                        ...
                        columnDef.methods = {
                            ...
                            keyEventF2 : function(keyName, searchStr) {
                                ...
                                var code = 'tradeNote';
                                /* 코드 팝업 호출 */
                                document.getElementById("tradeNoteStr").focus();
                                tradeNoteInsert(code, keyName, tradeData);
                            ...
                            keyEventEnter : function() {
                                ...
                                $('#tradeTbl').dzt('setKeyIn', 'RIGHT');
                                $('#tradeNoteStr').val(tradeData.tradeNote);
					...
					case 'regDate':
						...
						columnDef.lastCallback = function() {
							...
							/* 예금주 입력 글자수 제한 */
							if(tradeData.depositor.length > 30){
