				...
				<td class="twinbox_td">
					<div class="com_ta">
						<table>
							...
							<tr>
								<th><img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" /> ${CL.ex_evidenceType} ${CL.ex_code} <!-- 증빙유형  --> <!-- 코드 -->
								</th>
								<td>
							...
							<tr>
								<th><img src="<c:url value='/Images/ico/ico_check01.png'/>" alt="" /> ${CL.ex_evidenceType} ${CL.ex_name} <!-- 증빙유형  --> <!-- 명칭 -->
								</th>
								<td>
							...
							<tr>
								<th>${CL.ex_classificationTax}<br/> <!-- 부가세 구분 -->
								(${CL.ex_divisionBusiness}) <!-- 세무구분 --></th>
								<td>
