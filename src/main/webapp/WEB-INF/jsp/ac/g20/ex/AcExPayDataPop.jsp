    ...
    <div class="pop_con expense">      
        <div class="top_box" style="overflow:hidden;">
            ...
            <dl>
                ...
                <dd><input type="button" onclick="fnGetErpPayData();" id="searchButton" value="검색" /></dd>
            </dl>            
        </div>
        ...
        <div class="h2_btn2">
            ...
            <div class="controll_btn">
                <button type="button" onclick="javascript:erpG20PayData.addSubRow();">추가</button>
            </div>
        </div>
...
<!--                     <input type="checkbox" id="chkAll" name="chkAll" class="chkSel2"/> -->
                    ...
                    <th scope="col">주민세액</th>
                    <th scope="col">기타공급액</th>
        ...
        <div class="com_ta2 ova_sc" style="height:112px;">
             <table border="0" id="coCardList"> <tr><td colspan='12'>데이터가 존재하지 않습니다.</td></tr></table>
        </div>
        
        <div class="h2_btn2">
            <h2>선택리스트</h2>
            <div class="controll_btn">
                <button type="button" onclick="javascript:erpG20PayData.deleteSubRow();">삭제</button>
            </div>
        </div>
...
<!--                         <input type="checkbox" class="chkNo"/> -->
    ...
    <div class="pop_foot">
        <div class="btn_cen pt12">
            ...
            <input type="button" class="gray_btn" onclick="btnCancel();" value="취소" />
        </div>
    </div><!-- //pop_foot -->
    </div><!-- //pop_wrap -->
<!-- </body> -->
