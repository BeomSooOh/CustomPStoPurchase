...
function getACardList(dblClickparamMap){  
    ...
    var opt = {
            ...
            successFn : function(){
                ...
                paramMap.colNames = ["코드", "카드명(거래처명)", "카드번호", "구분"]; 
                paramMap.colModel = [
...
erpG20CoCardList.CoCardAList = function(){
    ...
    var opt = {  
            type:"post",
            url: '<c:url value="/Ac/G20/Ex/getErpACardSunginList.do"/>?' + param ,
            datatype:"json",        
            //data: data,
                ...
                var html = "";
                    ...
                    for(var i=0;i<resultData.length;i++){
                        ...
                        if(resultData[i].GW_STATE == null || resultData[i].GW_STATE == ""){
                            html += '<td> <input type="checkbox" class="chkNo k-checkbox"/> <label class="k-checkbox-label radioSel" for=""></label> ';
                        }else{
                            html += '<td> <input type="checkbox" disabled="disabled" class="chkNo k-checkbox"/><label class="k-checkbox-label radioSel" for=""></label>  ';
                        }
...
erpG20CoCardList.save= function(resultData){
    ...
    $.ajax({
        type:"post",
        url:'<c:url value="/neos/erp/g20/setG20CoCardList.do" />',
        datatype:"json",
        //data: data,
...
//         		 parent.window.close();
            	 ...
            	 alert("선택한리스트가 저장 하는중 오류가 발생하였습니다.");	 
             }   
         },error:function(e){
             alert("선택한리스트를 저장 하는중 오류가 발생하였습니다.");
         }
    });
    ...
    <div class="pop_con">      
        <div class="top_box" style="overflow:hidden;">
            ...
            <dl class="dl2">
                <dt>카드번호</dt>
                <dd class="mr0">
                        <input type="text" class="requirement" id="CARD_NB" style="width:134px;"/>
        ...
        <div class="h2_btn2">
            ...
            <div class="controll_btn">
                <button id=""  type="button" onclick="javascript:erpG20CoCardList.addSubRow();">추가</button>
            </div>
        </div>        
<!--         <div class="erpPopCon mT5" style="border-bottom:none;"> -->
        ...
        <div class="com_ta2 ova_sc" style="height:111px;">
            <table border="0" id="coCardList">
<%--                 <colgroup> --%>
<%--                     <col width="40"/> --%>
<%--                     <col width="70" /> --%>
<%--                     <col width="60" /> --%>
...
<!--                     <tr>             -->
<!--                         <td> -->
<!--                             <input type="checkbox" name="" id="" class="k-checkbox"> -->
<!--                             <label class="k-checkbox-label radioSel" for=""></label> -->
<!--                         </td> -->
<!--                         <td></td> -->
<!--                         <td></td> -->
<!--                         <td></td> -->
...
<!--                     </tr> -->
        ...
        <div class="h2_btn2">
            <h2>승인내역 선택리스트</h2>
            <div class="controll_btn">
                <button id="" type="button" onclick="javascript:erpG20CoCardList.deleteSubRow();">삭제</button>
            </div>
        </div>        
        <div class="com_ta2">
            <table border="0">
        ...
        <div class="com_ta2 ova_sc" style="height:111px;">
            <form id="subForm" name="subForm" method="post" action="<c:url value='/neos/erp/g20/setG20CoCardList.do'/>">
            ...
            <table border="0" id="coCardList_Sub">
                ...
                <c:forEach var="result" items="${selectList}" varStatus="status">
                     <tr id="${result.PKEY}">
                        ...
                        <td align="center" class="">${result.ISS_DATE}</td>
    ...
    <div class="pop_foot">
        <div class="btn_cen pt12">
            <input type="button" onclick="javascript:erpG20CoCardList.save();"   value="저장" />
            <input type="button" id="btnCancel" onclick="btnCancel()" class="gray_btn" value="취소" />
        </div>
    </div><!-- //pop_foot -->
