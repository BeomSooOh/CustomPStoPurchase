		...
		<div class="psh_btnbox">
			<div class="psh_right">
				<div class="btn_cen mt8">
					...
					<input type="button" class="psh_btn" onclick="titleOnClickApp('${contractDetailInfo.appr_dikey_plan}','','','','0','${contractDetailInfo.appr_status_plan}')" value="품의서보기" /> 
					<!-- <input type="button" class="psh_btn" onclick="titleOnClickApp('4183','','','','0','008')" value="품의서보기" /> --> 
					</c:if>
					<c:if test="${btnApprYn == 'Y'}">
