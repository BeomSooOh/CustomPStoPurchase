...
<head>
	...
	<script type="text/javascript">
		...
		function fnSelectShoppingList(){
			...
			,	body : {
					iframe : true
				,	url : "${pageContext.request.contextPath}/purchase/layer/SelectShoppingListLayer.do?inqryBgnDate=${fromDate}&inqryEndDate=${toDate}"
				,	iframeAttribute : {
					id : "dlgFrame"
				}							
			...
			,	footer : {
					...
					buttons : [
						...
						,	clickCallback : function( puddDlg ) {
								...
								var selectedData = iframeTag.contentWindow.getSelectedData();
			...
			<table>
				...
				<tr>
					...
					<td objKey="public_info" objCheckFor="getPublicInfo()" >
						...
						<a href="#n" onclick="fnSelectShoppingList(this)" class="btn_search" style="margin-left: -25px;"></a>
					</td>
				</tr>				
			</table>
		</div>
