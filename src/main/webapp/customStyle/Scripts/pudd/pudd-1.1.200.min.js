...
Pudd.Util.Outline=Pudd.invent({init:function(e){this.outlineRecArr=null,this.outlineRecObjArr=null,this.outlineLineArr=null,this.basisMinLine=6,this.basisMinCenterRec=30,this.parentTag=e,this.constructor.call(this)},inherit:Pudd.Util,extend:{initOutline:function(){this.outlineRecArr=[],this.outlineRecObjArr=[];for(var e=0;e<8;e++){var t=document.createElement("div");this.parentTag.appendChild(t),this.outlineRecArr.push(t);var i=new Pudd.Element(t);this.outlineRecObjArr.push(i),i.addClass("outlineRecLayer"),i.style("display:none;position:absolute;z-index:1001;width:5px;height:5px;border:1px solid #0000ff;background-color:#ffffff")}this.outlineLineArr=[];for(e=0;e<4;e++){t=document.createElement("div");this.parentTag.appendChild(t),this.outlineLineArr.push(t);i=new Pudd.Element(t);0==e||2==e?i.style("display:none;position:absolute;z-index:1001;width:1px;height:1px;border-left:1px solid #0000ff;border-top:0px;border-right:0px;border-bottom:0px;"):i.style("display:none;position:absolute;z-index:1001;width:1px;height:1px;border-left:0px;border-top:1px solid #0000ff;border-right:0px;border-bottom:0px;")}},registerEventCallback:function(t,i,l){var r=this;this.outlineRecObjArr[2].on("mousedown",function(e){e.preventDefault(),t.call(r,e,2),r.setupEvent(i,l,2)}),this.outlineRecObjArr[5].on("mousedown",function(e){e.preventDefault(),t.call(r,e,5),r.setupEvent(i,l,5)}),this.outlineRecObjArr[6].on("mousedown",function(e){e.preventDefault(),t.call(r,e,6),r.setupEvent(i,l,6)})},setupEvent:function(t,i,l){var r=this,s=Pudd.getInstance(this.parentTag),n={mouseMove:function(e){e.preventDefault(),window.getSelection().removeAllRanges(),t.call(r,e,l)},mouseUp:function(e){e.preventDefault(),s.off("mousemove",n.mouseMove),s.off("mouseup",n.mouseUp),i.call(r,e,l)}};s.on("mousemove",n.mouseMove),s.on("mouseup",n.mouseUp)},showOutline:function(e,t,i,l,r,s,n,o){for(var u=0;u<8;u++)if(null==this.outlineRecArr[u])return!1;for(u=0;u<4;u++){if(null==this.outlineLineArr[u])return!1;this.outlineLineArr[u].style.borderStyle=l?"dotted":"solid"}if(e){this.outlineRecArr[0].style.left=r-3+"px",this.outlineRecArr[0].style.top=s-3+"px",this.outlineRecArr[0].style.backgroundColor="#c0c0c0",this.outlineRecArr[0].style.cursor="default",this.outlineRecArr[1].style.left=n-4+"px",this.outlineRecArr[1].style.top=s-3+"px",this.outlineRecArr[1].style.backgroundColor="#c0c0c0",this.outlineRecArr[1].style.cursor="default",this.outlineRecArr[2].style.left=n-4+"px",this.outlineRecArr[2].style.top=o-4+"px",this.outlineRecArr[2].style.backgroundColor="#ffffff",this.outlineRecArr[2].style.cursor="NW-resize",this.outlineRecArr[3].style.left=r-3+"px",this.outlineRecArr[3].style.top=o-4+"px",this.outlineRecArr[3].style.backgroundColor="#c0c0c0",this.outlineRecArr[3].style.cursor="default",this.outlineRecArr[0].style.display="",this.outlineRecArr[1].style.display="",this.outlineRecArr[2].style.display="",this.outlineRecArr[3].style.display="";var h=n-r,p=o-s;if(h>this.basisMinCenterRec){var c=r+h/2-3;this.outlineRecArr[4].style.left=c+"px",this.outlineRecArr[4].style.top=s-3+"px",this.outlineRecArr[4].style.display="",this.outlineRecArr[4].style.backgroundColor="#c0c0c0",this.outlineRecArr[4].style.cursor="default",this.outlineRecArr[6].style.left=c+"px",this.outlineRecArr[6].style.top=o-4+"px",this.outlineRecArr[6].style.display="",this.outlineRecArr[6].style.backgroundColor="#ffffff",this.outlineRecArr[6].style.cursor="N-resize"}else this.outlineRecArr[4].style.display="none",this.outlineRecArr[6].style.display="none";if(p>this.basisMinCenterRec){var y=s+p/2-3;this.outlineRecArr[5].style.left=n-4+"px",this.outlineRecArr[5].style.top=y+"px",this.outlineRecArr[5].style.display="",this.outlineRecArr[5].style.backgroundColor="#ffffff",this.outlineRecArr[5].style.cursor="E-resize",this.outlineRecArr[7].style.left=r-3+"px",this.outlineRecArr[7].style.top=y+"px",this.outlineRecArr[7].style.display="",this.outlineRecArr[7].style.backgroundColor="#c0c0c0",this.outlineRecArr[7].style.cursor="default"}else this.outlineRecArr[5].style.display="none",this.outlineRecArr[7].style.display="none";if(p>this.basisMinLine?(t?(this.outlineLineArr[0].style.left=r+"px",this.outlineLineArr[0].style.top=s+3+"px",this.outlineLineArr[0].style.width="1px",this.outlineLineArr[0].style.height=p-6+"px"):(this.outlineLineArr[0].style.left=r+"px",this.outlineLineArr[0].style.top=s+"px",this.outlineLineArr[0].style.width="1px",this.outlineLineArr[0].style.height=p+"px"),this.outlineLineArr[0].style.display=""):this.outlineLineArr[0].style.display="none",h>this.basisMinLine?(t?(this.outlineLineArr[1].style.left=r+3+"px",this.outlineLineArr[1].style.top=s+"px",this.outlineLineArr[1].style.width=h-6+"px"):(this.outlineLineArr[1].style.left=r+"px",this.outlineLineArr[1].style.top=s+"px",this.outlineLineArr[1].style.width=h+"px"),this.outlineLineArr[1].style.display=""):this.outlineLineArr[1].style.display="none",p>this.basisMinLine?(t?(this.outlineLineArr[2].style.left=n-1+"px",this.outlineLineArr[2].style.top=s+3+"px",this.outlineLineArr[2].style.height=p-6+"px"):(this.outlineLineArr[2].style.left=n+"px",this.outlineLineArr[2].style.top=s+"px",this.outlineLineArr[2].style.height=p+"px"),this.outlineLineArr[2].style.display=""):this.outlineLineArr[2].style.display="none",h>this.basisMinLine?(t?(this.outlineLineArr[3].style.left=r+3+"px",this.outlineLineArr[3].style.top=o-1+"px",this.outlineLineArr[3].style.width=h-6+"px"):(this.outlineLineArr[3].style.left=r+"px",this.outlineLineArr[3].style.top=o+"px",this.outlineLineArr[3].style.width=h+"px"),this.outlineLineArr[3].style.display=""):this.outlineLineArr[3].style.display="none",!t)for(u=0;u<8;u++)this.outlineRecArr[u].style.display="none";if(!i)for(u=0;u<4;u++)this.outlineLineArr[u].style.display="none"}else{for(u=0;u<8;u++)this.outlineRecArr[u].style.display="none";for(u=0;u<4;u++)this.outlineLineArr[u].style.display="none"}}}});
