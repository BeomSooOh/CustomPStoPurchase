...
MakeTradeTable.mode.confer.getMiniPopHtml = function ( mode ) {
	...
	if ( mode == "0" ) {
		...
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_NDEP_AM" class="etc_pop" tabIndex="101" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004266", "소득금액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_INAD_AM" class="etc_pop" tabIndex="102" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				<tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004265", "소득세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_INTX_AM" class="etc_pop" tabIndex="103" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				<tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004267", "주민세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_RSTX_AM" class="etc_pop" tabIndex="104" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				<tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000003537", "귀속년월" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" value="" style="width:63px;" id="pop_ETCRVRS_YM_YYYY" maxlength="4" class="etc_pop" tabIndex="104"/>' + NeosUtil.getMessage ( "TX000000435", "년" ) + '<input type="text" value="" style="width:30px;" id="pop_ETCRVRS_YM_MM" maxlength="2" class="etc_pop" tabIndex="105" part="etcpop"/>' + NeosUtil.getMessage ( "TX000000436", "월" );
		html += '					</td>';
		html += '				<tr>';
		html += '			</table>';
		html += '		</div>';
		...
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_UNIT_AM" disabled="disabled"/>' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004265", "소득세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_INTX_AM" class="etc_pop" tabIndex="101"/>' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004267", "주민세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_RSTX_AM" class="etc_pop" tabIndex="102"/>' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000005531", "기타공제액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_WD_AM" class="etc_pop" tabIndex="103"/>' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000003537", "귀속년월" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" value="" style="width:63px;" id="pop_ETCRVRS_YM_YYYY" maxlength="4" class="etc_pop" tabIndex="104"/>' + NeosUtil.getMessage ( "TX000000435", "년" ) + '<input type="text" value="" style="width:30px;" id="pop_ETCRVRS_YM_MM" maxlength="2" class="etc_pop" tabIndex="105" part="paypop"/>' + NeosUtil.getMessage ( "TX000000436", "월" );
		html += '					</td>';
		html += '				</tr>';
		html += '			</table>';
		html += '		</div>';
		...
		html += '					<td>';
		html += '						<input class="k-textbox input_search fl etc_pop" type="text" value="" style="width:100px;" placeholder="" id="pop_CTD_CD" tabIndex="101"/>';
		html += '						<a href="#" class="btn_search fl" style="margin-left:-1px;" id="search-Event-T-etc"></a><input class="fl ml30 etc_pop" type="text" value="" style="width:95px;" id="pop_CTD_NM" tabIndex="102"/>';
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000009413", "필요경비율" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:63px;" class="etc_pop" tabIndex="102" id="etc_percent" disabled="disabled"/> %';
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004264", "필요경비금액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_NDEP_AM" class="etc_pop" tabIndex="103"/>' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004266", "소득금액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_INAD_AM" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004265", "소득세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_INTX_AM" class="etc_pop" tabIndex="104" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000004267", "주민세액" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" style="width:210px;" id="pop_RSTX_AM" class="etc_pop" tabIndex="105" />' + NeosUtil.getMessage ( "TX000000626", "원" );
		html += '					</td>';
		html += '				</tr>';
		html += '				<tr>';
		html += '					<th>' + NeosUtil.getMessage ( "TX000003537", "귀속년월" ) + '</th>';
		html += '					<td>';
		html += '						<input type="text" value="" style="width:63px;" id="pop_ETCRVRS_YM_YYYY" maxlength="4" class="etc_pop" tabIndex="106"/>' + NeosUtil.getMessage ( "TX000000435", "년" ) + '<input type="text" value="" style="width:30px;" id="pop_ETCRVRS_YM_MM" maxlength="2" class="etc_pop" tabIndex="107" part="etcpop"/>' + NeosUtil.getMessage ( "TX000000436", "월" );
		html += '					</td>';
		html += '				</tr>';
		html += '			</table>';
		html += '		</div>';
