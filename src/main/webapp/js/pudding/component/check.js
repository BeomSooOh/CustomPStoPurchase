...
(function ($) {
        ...
        $.each($(this), function (index, item) {
            ...
            if (opt.group != undefined) {
                ...
                $.each(opt.group.item, function (index, item) {
                    ...
                    console.log(newOpt.dash);
                    // 체크박스 생성
                    var puddCheckBox = new PuddCheckBox(parameter);
                    // 체크박스 생성
                    PuddManager.makeComponent($(newDIV), puddCheckBox);
    ...
    ComponentCommander.checkbox.prototype.setChecked = function( _json ){
	...
	/* 비활성화 */
	ComponentCommander.checkbox.prototype.setDisabled = function( _json ){
		if( _json == undefined ){  console.error( '인자 값이 없습니다.' ); return false; }
		var json = CommonUtil.castToJSONObject( _json );
		var $selector = CommonUtil.extractSelector( _json );
		var $top = $( '#' + $selector.attr( 'id' ) + '_div' );
	...
	/* 활성화 */
	ComponentCommander.checkbox.prototype.setEnabled = function( _json ){
		if( _json == undefined ){  console.error( '인자 값이 없습니다.' ); return false; }
		var json = CommonUtil.castToJSONObject( _json );
		var $selector = CommonUtil.extractSelector( _json );
		var $top = $( '#' + $selector.attr( 'id' ) + '_div' );
    ...
    */
    ...
    PuddCheckBox.prototype = {
        ...
        setElementAssembly: function () {
            ...
            if (this.option.dash != undefined && this.option.dash == true || String(this.option.dash).toUpperCase() === 'TRUE') {
                if (this.option.disabled != undefined && this.option.disabled == true || String( this.option.disabled ).toUpperCase() === 'TRUE') {
        ...
        setElementAttribute: function () {
            ...
            if (this.INPUT != null) {
                puddCheckBoxAttribute.pushInputAttribute(this.$INPUT, this.option, this.id, this.inName, this.inOnClick );
            }
