                                ...
                                if (info.autoCreateRow === 'Y') {
                                    ...
                                    if (info.linkTableName === info.myTableName) { //자기자신의 테이블로 연결되어 있다면 로우 추가											
                                        ...
                                        if (nextElementId === '') {
                                            ...
                                            $.devTable.addrow(info.linkTableName, info.linkJsonData, info.linkTableType, info.linkParentElementId, window[info.tableRowNumVariableName],info.groupDisplayYN);
