...
/* 마스터 팝업 옵션*/
var master_disp = ['001001','001002','001003','001004','001005','001006','001007','001008','001009'];
var master_func = ['003002','003003','003004','003007','003101','003102','003104','003301','003303','003106','003107','003109'];
var master_date = ['002001','002002','002003','002004'];

/* 리스트 팝업 옵션*/
var list_disp = ['000002','001002','001003','001004','001005','001006','001009'];
var list_func = ['003002','003101','003103','003301','003302','003303','003304','003305','003106','003108','003111'];
var list_date = [];

/* 분개 팝업 옵션*/
var slip_disp = ['000002','001002','001003','001004','001005','001006','001009'];
var slip_func = ['003002','003101','003103','003301','003302','003303','003304','003305','003106','003108','003111'];
var slip_date = [];
...
/* 카드사용내역 팝업 옵션*/
var card_disp = ['001004','001009'];
var card_func = ['003002','003005','003101','003301','003302'];
var card_date = [];

/* 매입전자세금계산서 팝업 옵션*/
var etax_disp = ['001004','001006','001009'];
var etax_func = ['003002','003101','003301','003302','003110'];
var etax_date = [];
...
//				$('.ExpendSlipCard').hide();
		...
		case '001008' : // 표준적요 명칭 설정
			...
			break;
		case '001009' : // 공통팝업 코드 정렬 기준 데이터 타입
			if (displayOption.value.toString().toLowerCase() == "auto") {
				codeSortType = "";
			} else {
				codeSortType = displayOption.value.toString();
			}
			break;
	}
}
...
function fnSetDateMap() {
	...
	/* 전월 */
	for (var i = 1; i <= 31; i++) {
		var d = mLastDate < i ? mLastDate : i;
		op_date_map.put('m1_' + i.toString(), mYear + '-' + mMonth + '-' + (d.toString()[1] ? d.toString() : "0" + d.toString()));
	}

	/* 당월 */
	for (var i = 1; i <= 31; i++) {
		var d = lastDate < i ? lastDate : i;
		op_date_map.put('p0_' + i.toString(), year + '-' + month + '-' + (d.toString()[1] ? d.toString() : "0" + d.toString()));
	}

	/* 익월 */
	for (var i = 1; i <= 31; i++) {
		var d = pLastDate < i ? pLastDate : i;
		op_date_map.put('p1_' + i.toString(), pYear + '-' + pMonth + '-' + (d.toString()[1] ? d.toString() : "0" + d.toString()));
	}
...
function fnReflectFunctionOption(functionOption, moduleType){
	...
	case '003103' :  // 카드사용내역 연동시 금액 편집 설정
		...
		break;
	case '003111' :  // 매입전자세금계산서 연동시 금액 편집 설정
			if(functionOption.value == "Y"){
				updateEtaxAmt = true;
			}
			break;
