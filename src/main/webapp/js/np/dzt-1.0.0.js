...
(function ($) {
    ...
    var dztVars = {
        ...
        defType: ['text', 'readonly', 'datepicker', 'combobox'],
    ...
    if(langCode.toLowerCase() == 'en'){
    	dztVars.dateOptions = {
                ...
                dateFormat: "yy-mm-dd",
                dayNamesMin: ["Sun", "Mon", "Tue", "Wed", "Tue", "Fri", "Sat"],
            ...
            content: {
                ...
                addRow: function (main) {
                    ...
                    $.each($.fn.dzt.options[mainId]['columns'], function (idx, item) {
                        ...
                        /* TODO: 이벤트 정의 필요 */
                        $(td).click(function (event) { if (['SPAN', 'TD'].indexOf(event.target.tagName) > -1) { apis.event.setFocus(main, event); } return; });
                    });
